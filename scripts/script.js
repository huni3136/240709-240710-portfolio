...
//swiper 클래스 대상의 안에 작성했을 땐 swiper가 absolute를 잡는 relative 기본 내장으로 별도 설정을 안해도 되지만 밖에 작성했을 땐 밖 위치 기준으로 그 부모에게 relative 설정을 따로 해줘야 한다!!

//sns swiper
const snsS = new Swiper('.sns .swiper',{
    slidesPerView:2,//한번에 보일 슬라이드 수
    spaceBetween:20,//슬라이드 사이 여백
    autoplay:{delay:1,desableOnInteration:true,}, /* 상호작용후 자연스럽게 움직임 */
    loop:true,
    speed:8000,
    freemode:true,
    //반응형 슬라이드 수
